...
---------------------- INPUT FILES ---------------------------------------------
"iea15mw_01_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"iea15mw_01_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"iea15mw_01_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"iea15mw_01_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"iea15mw_01_HydroDyn.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"iea15mw_01_SubDyn.dat" SubFile     - Name of file containing sub-structural input parameters (quoted string)
