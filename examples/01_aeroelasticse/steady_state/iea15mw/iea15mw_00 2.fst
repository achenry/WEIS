...
---------------------- INPUT FILES ---------------------------------------------
"iea15mw_00_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"iea15mw_00_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"iea15mw_00_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"iea15mw_00_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"iea15mw_00_HydroDyn.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"iea15mw_00_SubDyn.dat" SubFile     - Name of file containing sub-structural input parameters (quoted string)
