...
class InputWriter_OpenFAST(object):
    ...
    def write_ElastoDyn(self):
        ...
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['OoPDefl'], 'OoPDefl', '- Initial out-of-plane blade-tip displacement (meters)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['IPDefl'], 'IPDefl', '- Initial in-plane blade-tip deflection (meters)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['BlPitch1'], 'BlPitch(1)', '- Blade 1 initial pitch (degrees)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['BlPitch2'], 'BlPitch(2)', '- Blade 2 initial pitch (degrees)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['BlPitch3'], 'BlPitch(3)', '- Blade 3 initial pitch (degrees) [unused for 2 blades]\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['TeetDefl'], 'TeetDefl', '- Initial or fixed teeter angle (degrees) [unused for 3 blades]\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['Azimuth'], 'Azimuth', '- Initial azimuth angle for blade 1 (degrees)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['RotSpeed'], 'RotSpeed', '- Initial or fixed rotor speed (rpm)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['NacYaw'], 'NacYaw', '- Initial or fixed nacelle-yaw angle (degrees)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['TTDspFA'], 'TTDspFA', '- Initial fore-aft tower-top displacement (meters)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['TTDspSS'], 'TTDspSS', '- Initial side-to-side tower-top displacement (meters)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['PtfmSurge'], 'PtfmSurge', '- Initial or fixed horizontal surge translational displacement of platform (meters)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['PtfmSway'], 'PtfmSway', '- Initial or fixed horizontal sway translational displacement of platform (meters)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['PtfmHeave'], 'PtfmHeave', '- Initial or fixed vertical heave translational displacement of platform (meters)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['PtfmRoll'], 'PtfmRoll', '- Initial or fixed roll tilt rotational displacement of platform (degrees)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['PtfmPitch'], 'PtfmPitch', '- Initial or fixed pitch tilt rotational displacement of platform (degrees)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['ElastoDyn']['InitialConditions']['PtfmYaw'], 'PtfmYaw', '- Initial or fixed yaw rotational displacement of platform (degrees)\n'))
    ...
    def write_SubDyn(self):
        ...
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['SubDyn']['ExtraMoment'], 'ExtraMoment', '- Include extra moment from lever arm at interface in interface reactions.\n'))
        ...
        for i in range(self.fst_vt['SubDyn']['NJoints']):
            ...
            ln.append('{:^11}'.format(self.fst_vt['SubDyn']['JointDamp'][i]))
            f.write(" ".join(ln) + '\n')
        ...
        for i in range(self.fst_vt['SubDyn']['NReact']):
            ...
            ln.append('{:^11}'.format(self.fst_vt['SubDyn']['SSIfile'][i]))
            f.write(" ".join(ln) + '\n')
        ...
        f.write(" ".join(['{:^11s}'.format(i) for i in ['PropSetID', 'EA', 'MatDens', 'T0', 'CtrlChannel']])+'\n')
        ...
        for i in range(self.fst_vt['SubDyn']['NCablePropSets']):
            ...
            ln.append('{:^11}'.format(self.fst_vt['SubDyn']['CtrlChannel'][i]))
            f.write(" ".join(ln) + '\n')
    ...
    def write_MoorDyn(self):
        ...
        f.write('----------------------- LINE TYPES ------------------------------------------\n')
        # f.write('{:<22d} {:<11} {:}'.format(self.fst_vt['MoorDyn']['LineTypes']['NLineTypes'], 'NLineTypes', '- number of LineTypes\n'))
        ...
        for i in range(self.fst_vt['MoorDyn']['LineTypes']['NLineTypes']):
            ln = []
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['Name'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['Diam'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['MassDen'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['EA'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['BA_zeta'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['EI'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['Cd'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['Ca'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['CdAx'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['LineTypes']['CaAx'][i]))
            f.write(" ".join(ln) + '\n')

        f.write('----------------------- ROD TYPES ------------------------------------------\n')
        # f.write('{:<22d} {:<11} {:}'.format(self.fst_vt['MoorDyn']['RodTypes']['NRodTypes'], 'NRodTypes', '- number of RodTypes\n'))
        f.write(" ".join(['{:^11s}'.format(i) for i in ['TypeName', 'Diam', 'Mass/m', 'Cd', 'Ca', 'CdEnd', 'CaEnd']])+'\n')
        f.write(" ".join(['{:^11s}'.format(i) for i in ['(-)', '(m)', '(kg/m)', '(-)', '(-)', '(-)', '(-)']])+'\n')
        for i in range(self.fst_vt['MoorDyn']['RodTypes']['NRodTypes']):
            ln = []
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['RodTypes']['TypeName'][i]))
            ln.append('{:^11f}'.format(self.fst_vt['MoorDyn']['RodTypes']['Diam'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['RodTypes']['Mass/m'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['RodTypes']['Cd'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['RodTypes']['Ca'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['RodTypes']['CdEnd'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['RodTypes']['CaEnd'][i]))
            f.write(" ".join(ln) + '\n')
        ...
        for i in range(self.fst_vt['MoorDyn']['Rods']['NRods']):
            ...
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Rods']['Xb'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Rods']['Yb'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Rods']['Zb'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Rods']['NumSegs'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Rods']['RodOutputs'][i]))
            f.write(" ".join(ln) + '\n')
        ...
        for i in range(self.fst_vt['MoorDyn']['Nodes']['NConnects']):
            ...
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Nodes']['Mass'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Nodes']['Volume'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Nodes']['CdA'][i]))
            ln.append('{:^11}'.format(self.fst_vt['MoorDyn']['Nodes']['Ca'][i]))
            f.write(" ".join(ln) + '\n')
        ...
        f.write('---------------------- SOLVER OPTIONS ---------------------------------------\n')
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['MoorDyn']['Solver']['dtM'], 'dtM', '- time step to use in mooring integration (s)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['MoorDyn']['Solver']['kbot'], 'kbot', '- bottom stiffness (Pa/m)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['MoorDyn']['Solver']['cbot'], 'cbot', '- bottom damping (Pa-s/m)\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['MoorDyn']['Solver']['dtIC'], 'dtIC', '- time interval for analyzing convergence during IC gen (s)\n'))
