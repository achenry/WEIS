...
class LinearFAST(runFAST_pywrapper_batch):
    ...
    def runFAST_steady(self):
        ...
        channels = {}
        for var in ["TipDxc1", "TipDyc1", "TipDzc1", "TipDxb1", "TipDyb1", "TipDxc2", "TipDyc2", "TipDzc2", "TipDxb2",
                    "TipDyb2", "TipDxc3", "TipDyc3", "TipDzc3", "TipDxb3", "TipDyb3", "RootMxc1", "RootMyc1",
                    "RootMzc1", "RootMxb1", "RootMyb1", "RootMxc2", "RootMyc2", "RootMzc2", "RootMxb2", "RootMyb2",
                    "RootMxc3", "RootMyc3", "RootMzc3", "RootMxb3", "RootMyb3", "TwrBsMxt", "TwrBsMyt", "TwrBsMzt",
                    "GenPwr", "GenTq", "RotThrust", "RtAeroCp", "RtAeroCt", "RotSpeed", "BldPitch1", "TTDspSS",
                    "TTDspFA", "NacYaw", "Wind1VelX", "Wind1VelY", "Wind1VelZ", "LSSTipMxa", "LSSTipMya", "LSSTipMza",
        ...
        case_list, case_name_list = CaseGen_General(case_inputs, dir_matrix=self.FAST_steadyDirectory,
                                                    namebase='steady')
    ...
    def runFAST_linear(self):
        ...
        for ic in ss_ops:
            if ic != 'Wind1VelX':
                case_inputs[("ElastoDyn", ic)] = {
                    'vals': np.interp(case_inputs[("InflowWind", "HWindSpeed")]['vals'], uu, ss_ops[ic]).tolist(),
                    'group': 1}
        ...
        channels = {}
        for var in ["BldPitch1", "BldPitch2", "BldPitch3", "IPDefl1", "IPDefl2", "IPDefl3", "OoPDefl1", "OoPDefl2",
                    "OoPDefl3", \
                    "NcIMURAxs", "TipDxc1", "TipDyc1", "Spn2MLxb1", "Spn2MLxb2", "Spn2MLxb3", "Spn2MLyb1", "Spn2MLyb2",
                    "Spn2MLyb3" \
                    "TipDzc1", "TipDxb1", "TipDyb1", "TipDxc2", "TipDyc2", "TipDzc2", "TipDxb2", "TipDyb2", "TipDxc3",
                    "TipDyc3", \
                    "TipDzc3", "TipDxb3", "TipDyb3", "RootMxc1", "RootMyc1", "RootMzc1", "RootMxb1", "RootMyb1",
                    "RootMxc2", \
                    "RootMyc2", "RootMzc2", "RootMxb2", "RootMyb2", "RootMxc3", "RootMyc3", "RootMzc3", "RootMxb3",
                    "RootMyb3", \
                    "TwrBsMxt", "TwrBsMyt", "TwrBsMzt", "GenPwr", "GenTq", "RotThrust", "RtAeroCp", "RtAeroCt",
                    "RotSpeed", \
                    "TTDspSS", "TTDspFA", "NacYaw", "Wind1VelX", "Wind1VelY", "Wind1VelZ", "LSSTipMxa", "LSSTipMya",
                    "LSSTipMza", \
                    "LSSTipMxs", "LSSTipMys", "LSSTipMzs", "LSShftFys", "LSShftFzs", "TipRDxr", "TipRDyr", "TipRDzr" \
                                                                                                           "TwstDefl1",
                    "TwstDefl2", "TwstDefl3"]:
...
def gen_linear_model(wind_speeds, Tmax=600.):
    ...
    linear.FAST_directory = os.path.join(linear.weis_dir,
                                         'examples/01_aeroelasticse/OpenFAST_models/IEA-15-240-RWT/IEA-15-240-RWT-UMaineSemi')  # Path to fst directory files
